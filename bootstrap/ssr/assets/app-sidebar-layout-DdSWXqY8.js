...
import { XIcon, PanelLeftOpenIcon, PanelLeftCloseIcon, ChevronRight, Palette, LogOut, ChevronsUpDown, LayoutGrid, PackageMinus, Wrench, Folder, BookOpen } from "lucide-react";
...
import { b as logout, q as queryParams, d as dashboard } from "./index-DF_fN02X.js";
        ...
        return /* @__PURE__ */ jsx(
          Collapsible,
          {
            ...
            children: /* @__PURE__ */ jsxs(SidebarMenuItem, { children: [
              ...
              /* @__PURE__ */ jsx(CollapsibleContent, { children: /* @__PURE__ */ jsx(SidebarMenuSub, { children: item.items.map((subItem) => /* @__PURE__ */ jsx(
                SidebarMenuSubItem,
                {
                  children: /* @__PURE__ */ jsx(
...
buscarProdutos.url = (options) => {
  return buscarProdutos.definition.url + queryParams(options);
};
buscarProdutos.post = (options) => ({
  url: buscarProdutos.url(options),
  method: "post"
});
const buscarProdutosForm = (options) => ({
  action: buscarProdutos.url(options),
  method: "post"
});
buscarProdutosForm.post = (options) => ({
  action: buscarProdutos.url(options),
  method: "post"
});
buscarProdutos.form = buscarProdutosForm;
const buscarPorCodigo = (options) => ({
...
buscarPorCodigo.url = (options) => {
  return buscarPorCodigo.definition.url + queryParams(options);
};
buscarPorCodigo.post = (options) => ({
  url: buscarPorCodigo.url(options),
  method: "post"
});
const buscarPorCodigoForm = (options) => ({
  action: buscarPorCodigo.url(options),
  method: "post"
});
buscarPorCodigoForm.post = (options) => ({
  action: buscarPorCodigo.url(options),
  method: "post"
});
...
recriar.post = (options) => ({
  url: recriar.url(options),
  method: "post"
});
const recriarForm = (options) => ({
  action: recriar.url(options),
  method: "post"
});
recriarForm.post = (options) => ({
  action: recriar.url(options),
  method: "post"
});
...
const statusForm = (options) => ({
  action: status.url(options),
  method: "get"
});
statusForm.get = (options) => ({
  action: status.url(options),
  method: "get"
});
statusForm.head = (options) => ({
  action: status.url({
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
